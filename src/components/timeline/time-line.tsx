    ...
    <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
      <li>
        ...
        <div className="timeline-middle">
          {createVertex(VertexType.Milestone)}
        </div>
      ...
      <li>
        <hr />
        <div className="timeline-middle">{createVertex(VertexType.Major)}</div>
        <hr />
      </li>
      ...
      <li>
        ...
        <div className="timeline-start md:text-end">
          ...
          <div className="text-lg font-black">Univercity Enterence (UoP)</div>
        </div>
        <hr />
      </li>
