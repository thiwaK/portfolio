...
export default function Navbar({
  ...
  const getSystemTheme = (): Theme => window.matchMedia("(prefers-color-scheme: dark)").matches
      ? darkThemeName
      : lightThemeName;
  ...
  // we can simply use `bottom-b` instead of this complex -bottom-[5px]
  return (
    <header className="sticky top-0 left-0 z-999 backdrop-blur transition duration-500 bg-base-100 shadow-md shadow-base-300">
      <ScrollProgress />
